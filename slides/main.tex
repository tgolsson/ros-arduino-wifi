...
\usepackage{multicol, marginnote, multimedia}
%\usepackage{natbib}
...
\begin{frame}{Video: Figure 8}
  \begin{centering}
    \movie[externalviewer]{\larger Start playback}{20160111_001.mp4}
  \end{centering}
\end{frame}
...
\begin{frame}{Video: Wheel demonstrations}
  \begin{centering}
    \movie[externalviewer]{\larger Start playback}{20160111_005.mp4}
  \end{centering}
\end{frame}
{ \smaller
